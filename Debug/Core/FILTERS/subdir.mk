...
C_SRCS += \
../Core/FILTERS/filter.c 

OBJS += \
./Core/FILTERS/filter.o 

C_DEPS += \
./Core/FILTERS/filter.d 
...
clean-Core-2f-FILTERS:
	-$(RM) ./Core/FILTERS/filter.cyclo ./Core/FILTERS/filter.d ./Core/FILTERS/filter.o ./Core/FILTERS/filter.su
